    ...
    <form action={formAction} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <div>
          ...
          <input id="niche" name="niche" className="input" placeholder="Ex.: beleza, casa" />
        </div>
        <div>
      ...
      <div>
        <label className="label" htmlFor="desiredCoupon">
          Cupom desejado (opcional)
        </label>
        <input
          id="desiredCoupon"
          name="desiredCoupon"
          className="input"
          placeholder="Ex.: MARIA10 — sujeito à disponibilidade"
        />
      </div>

      <div>
        <label className="label" htmlFor="pitch">
          Conte um pouco sobre você e por que quer divulgar a Botanika
        </label>
      ...
      <div className="flex items-center justify-between gap-4 pt-2">
        <p className="text-xs text-[var(--muted)]">
          Ao enviar, seu cadastro fica em análise. Você recebe o acesso após a
          aprovação.
        </p>
