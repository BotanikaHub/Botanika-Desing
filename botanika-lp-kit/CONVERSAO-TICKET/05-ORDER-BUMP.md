...
- **CTA estourando lateral:** `.btn{white-space:nowrap}` é global → texto longo **corta na lateral**. Mantenha o texto do CTA do bump curto (`COMPRAR KIT + <PRODUTO>`, sem a contagem — a contagem já aparece na buybar).
